...
-- 3. Create session_analytics table
...
-- 6. Create RLS Policies for voice_sessions
...
-- 7. Create RLS Policies for transcripts
...
-- 8. Create RLS Policies for session_analytics
...
-- 9. Create trigger functions for updating timestamps
...
-- 12. VERIFICATION - Run this after to confirm tables were created
SELECT
