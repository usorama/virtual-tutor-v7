-- EXECUTE THIS SQL IN SUPABASE SQL EDITOR TO FIX THE VOICE_SESSIONS TABLE ERROR
-- Go to: https://supabase.com/dashboard/project/thhqeoiubohpxxempfpi/sql/new
-- Copy and paste this entire SQL script and execute it
...
-- VERIFICATION: After executing this script, run this query to verify tables were created:
-- SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name IN ('voice_sessions', 'transcripts', 'session_analytics');